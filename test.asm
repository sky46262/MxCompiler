...
_Label_322:
	...
	call	_func_xorshift
	mov	r13, rax
	mov	r12, qword [rbp-50H]
	add	r12, r13
	mov	qword [rbp-50H], r12
	...
	call	_func_xorshift
	mov	r13, rax
	mov	r12, qword [rbp-58H]
	add	r12, r13
	mov	qword [rbp-58H], r12
	inc	r8
	jmp	_Label_401
_Label_311:
	inc	qword [rbp-68H]
